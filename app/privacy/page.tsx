...
export default function PrivacyPage() {
  return (
    <div className="overflow-x-hidden relative bg-black min-h-screen">
      <NavBar />
      <main className="prose prose-invert mx-auto py-12 px-4 max-w-4xl text-white">
        ...
        <section>
          ...
          <p>Our services are not directed to individuals under 13 years of age. We do not knowingly collect personal information from children under 13. If we become aware of such collection, we will take steps to delete the information.</p>
        </section>
